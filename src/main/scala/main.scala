  ...
  def main(args: Array[String]) {
    ...
    val res = args(0) match {
      ...
      */
      ...
      case "Risc" =>
        chiselMainTest(chiselArgs, () => Module(new Risc))(c => new DaisyReplay(c))
      case "GCD" =>
        chiselMainTest(chiselArgs, () => Module(new GCD))(c => new DaisyReplay(c))
      case "Parity" =>
        chiselMainTest(chiselArgs, () => Module(new Parity))(c => new DaisyReplay(c))
      case "Stack" =>
        chiselMainTest(chiselArgs, () => Module(new Stack(8)))(c => new DaisyReplay(c))
      case "Router" =>
        chiselMainTest(chiselArgs, () => Module(new Router))(c => new DaisyReplay(c))
      case "ShiftRegister" =>
        chiselMainTest(chiselArgs, () => Module(new ShiftRegister))(c => new DaisyReplay(c))
      case "ResetShiftRegister" =>
        chiselMainTest(chiselArgs, () => Module(new ResetShiftRegister))(c => new DaisyReplay(c))
      case "EnableShiftRegister" =>
        chiselMainTest(chiselArgs, () => Module(new EnableShiftRegister))(c => new DaisyReplay(c))
      case "MemorySearch" =>
        chiselMainTest(chiselArgs, () => Module(new MemorySearch))(c => new DaisyReplay(c))
      case "FIR2D" =>
        chiselMainTest(chiselArgs, () => Module(new FIR2D(32, 8, 3)))(c => new DaisyReplay(c))
      case "Tile" => 
